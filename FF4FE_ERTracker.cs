...
namespace FF4FE_ERTracker
{
    ...
    internal static class EntranceTable
    {
            ...
            new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            { "OW(210,130)",  "Silvera"              },
            { "OW(213,209)",  "Chocobo's Forest"     },
            { "OW(215,58)",   "Fabul"                },
            { "OW(218,199)",  "Mt.Ordeals"           },
            { "OW(219,136)",  "Grotto Adamant"       },
            { "OW(228,47)",   "Chocobo's Forest"     },
            { "OW(24,231)",   "Cave Eblan"           },
            { "OW(34,101)",   "Chocobo's Forest"     },
            ...
            { "OW(76,132)",   "Misty Cave"           },
            { "OW(84,119)",   "Misty Cave"           },
            { "OW(86,79)",    "Chocobo's Forest"     },
            { "OW(89,163)",   "Chocobo's Forest"     },
